---
name: gwas-analysis
description: Genome-wide association study design, QC, and interpretation.
---

## When to Use

Use this atomic skill for focused work on **gwas-analysis** without bundling unrelated topics.

## Quick Reference

This skill was split from `gwas-population-genetics.md` to keep topics independent and self-contained.
...
- `gwas-analysis` (this file)
- `gwas-population-genetics` (legacy merged skill)
