...
description: "Split from `01_lists_and_tuples.ipynb` to keep this topic self-contained."
tool_type: python
source_notebook: "Tier_1_Python_for_Bioinformatics/08_Lists_and_Tuples/01_lists.ipynb"
primary_tool: Python
---
...
*Source: Course notebook `Tier_1_Python_for_Bioinformatics/08_Lists_and_Tuples/01_lists.ipynb`*

# Lists

Split from `01_lists_and_tuples.ipynb` to keep this topic self-contained.

**Navigation:** [Topic overview](./01_lists_and_tuples.ipynb) · [Next: Tuples](./02_tuples.ipynb)
