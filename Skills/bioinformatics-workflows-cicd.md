...
description: Workflow engines and CI/CD for bioinformatics pipelines.
---

## When to Use

Use this atomic skill for focused work on **bioinformatics-workflows-cicd** without bundling unrelated topics.
...
- `bioinformatics-workflows-cicd` (this file)
