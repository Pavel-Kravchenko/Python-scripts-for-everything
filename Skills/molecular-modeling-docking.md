---
name: molecular-modeling-docking
description: Molecular modeling, docking, and MD workflow foundations.
---

## When to Use

Use this atomic skill for focused work on **molecular-modeling-docking** without bundling unrelated topics.
...
- `molecular-modeling-docking` (this file)
