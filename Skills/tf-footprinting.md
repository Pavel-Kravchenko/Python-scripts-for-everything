...
description: Transcription factor footprinting from chromatin accessibility profiles.
---

## When to Use

Use this atomic skill for focused work on **tf-footprinting** without bundling unrelated topics.
