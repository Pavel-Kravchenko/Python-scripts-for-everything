...
description: "Split from `01_biochemistry_and_enzyme_kinetics.ipynb` to keep this topic self-contained."
tool_type: python
source_notebook: "Tier_3_Applied_Bioinformatics/13_Biochemistry_and_Enzyme_Kinetics/01_biochemistry.ipynb"
primary_tool: NumPy
---
...
*Source: Course notebook `Tier_3_Applied_Bioinformatics/13_Biochemistry_and_Enzyme_Kinetics/01_biochemistry.ipynb`*
