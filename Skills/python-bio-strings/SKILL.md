...
description: "Python string operations for bioinformatics: DNA/RNA sequence manipulation, complement, reverse complement, GC content, and pattern matching. Use when processing biological sequences as strings."
tool_type: python
source_notebook: "Tier_1_Python_for_Bioinformatics/04_Strings_and_Sequences/01_strings.ipynb"
primary_tool: Python
---
...
*Source: Course notebook `Tier_1_Python_for_Bioinformatics/04_Strings_and_Sequences/01_strings.ipynb`*


Split from `01_strings_and_sequences.ipynb` to keep this topic self-contained.

**Navigation:** [Topic overview](./01_strings_and_sequences.ipynb) · [Next: Sequences](./02_sequences.ipynb)
...
```python
# Creating biological sequence strings
dna = "ATGCGATCGATCGTAGCATGCAT"
rna = "AUGCGAUCGAUCGUAGCAUGCAU"
protein = "MKVLWAALLVLLGFANATQAQA"

print(f"DNA sequence:     {dna}")
print(f"RNA sequence:     {rna}")
print(f"Protein sequence: {protein}")
print(f"\nDNA length: {len(dna)} nucleotides")
