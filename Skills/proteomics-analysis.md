...
description: Mass spectrometry proteomics analysis and protein identification workflows.
---

## When to Use

Use this atomic skill for focused work on **proteomics-analysis** without bundling unrelated topics.

## Quick Reference

This skill was split from `genome-assembly-proteomics.md` to keep topics independent and self-contained.
...
- `proteomics-analysis` (this file)
- `genome-assembly-proteomics` (legacy merged skill)
