...
description: Diffusion model fundamentals and DDPM/DDIM sampling patterns.
---

## When to Use

Use this atomic skill for focused work on **diffusion-models** without bundling unrelated topics.

## Quick Reference

This skill was split from `diffusion-generative.md` to keep topics independent and self-contained.
...
- `diffusion-models` (this file)
- `diffusion-generative` (legacy merged skill)
